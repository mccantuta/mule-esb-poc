...
-----------------------------------------------------------------
./src/test/java/com.mccl.mule/mulepoc/MulepocTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/mulepoc-functional-test-config.xml

Defines the Mule configuration for the MulepocTestCase.java.
...
artifactId=mulepoc
description=Mule proof of concept
muleVersion=3.8.1
packagePath=com/mycompany/mule
forgeProject=n
transports=file,http,jdbc,jms,vm,servlet
modules=client,cxf,json,management,scripting,spring-extras,spring-security,sxc,xml

version=1.0-SNAPSHOT
groupId=com.mccl.mule
basedir=/Users/mccantuta/Development/workspace/mule
--------------------------------------------------------------------